...
function socialWindowScreen(url){
    ...
    var parans ="menubar=no,toolbar=no,status=no,width=570,height=570,top="+top +",left"+left;
    window.open(url,"NewWindow",parans);
...
function setShareLinks (){
    ...
    $(".social-share-url.facebook").on("click",function(){
        url = "https://www.facebook.com/sharer.php?u=calibergaming.in" +pageUrl;
